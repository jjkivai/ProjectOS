...
// extern "C" void install_isr_wrapper(CPU* cpu) {
//     cpu->install_isr();
// }
void CPU::install_isr() {
    /* Setup the ISR's*/
    ...
    // Idt.set_entry2(Idt.Table[32], (uint32_t)isr32, 0x8E);

    Idt.set_entry(33, (uint32_t)irq1, 0x8E);
    // Idt.set_entry2(Idt.Table[33], (uint32_t)isr33, 0x8E);

    Idt.set_entry(34, (uint32_t)irq2, 0x8E);
    // Idt.set_entry2(Idt.Table[35], (uint32_t)isr34, 0x8E);

    Idt.set_entry(35, (uint32_t)irq3, 0x8E);
    // Idt.set_entry2(Idt.Table[35], (uint32_t)isr35, 0x8E);

    Idt.set_entry(36, (uint32_t)irq4, 0x8E);
    // Idt.set_entry2(Idt.Table[36], (uint32_t)isr36, 0x8E);

    Idt.set_entry(37, (uint32_t)irq5, 0x8E);
    // Idt.set_entry2(Idt.Table[37], (uint32_t)isr37, 0x8E);

    Idt.set_entry(38, (uint32_t)irq6, 0x8E);
    // Idt.set_entry2(Idt.Table[38], (uint32_t)isr38, 0x8E);
    
    Idt.set_entry(39, (uint32_t)irq7, 0x8E);
    // Idt.set_entry2(Idt.Table[39], (uint32_t)isr39, 0x8E);

    Idt.set_entry(40, (uint32_t)irq8, 0x8E);
    // Idt.set_entry2(Idt.Table[40], (uint32_t)isr40, 0x8E);

    Idt.set_entry(41, (uint32_t)irq9, 0x8E);
    // Idt.set_entry2(Idt.Table[41], (uint32_t)isr41, 0x8E);

    Idt.set_entry(42, (uint32_t)irq10, 0x8E);
    // Idt.set_entry2(Idt.Table[42], (uint32_t)isr42, 0x8E);

    Idt.set_entry(43, (uint32_t)irq11, 0x8E);
    // Idt.set_entry2(Idt.Table[43], (uint32_t)isr43, 0x8E);

    Idt.set_entry(44, (uint32_t)irq12, 0x8E);
    // Idt.set_entry2(Idt.Table[44], (uint32_t)isr44, 0x8E);

    Idt.set_entry(45, (uint32_t)irq13, 0x8E);
    // Idt.set_entry2(Idt.Table[45], (uint32_t)isr45, 0x8E);

    Idt.set_entry(46, (uint32_t)irq14, 0x8E);
    // Idt.set_entry2(Idt.Table[46], (uint32_t)isr46, 0x8E);

    Idt.set_entry(47, (uint32_t)irq15, 0x8E);
    // Idt.set_entry2(Idt.Table[47], (uint32_t)isr47, 0x8E);
